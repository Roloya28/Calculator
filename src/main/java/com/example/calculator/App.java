...
public class App {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("현재 저장된 결과 수 [값]: " + calculator.getResults().size() + " " + calculator.getResults());

            System.out.println("가장 먼저 저장한 값을 삭제 하시겠습니까?");
            System.out.println("(delete 입력시 삭제 or 아무키 입력으로 continue)");
            ...
            System.out.println("계속 계산하시겠습니까? (exit 입력시 종료)");
            String exit = sc.next();
